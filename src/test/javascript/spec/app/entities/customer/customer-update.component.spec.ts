...
import { CustomerUpdateComponent } from '@store/entities/customer/customer-update.component';
import { CustomerService } from '@store/entities/customer/customer.service';
import { Customer } from '@store/shared/model/customer.model';
