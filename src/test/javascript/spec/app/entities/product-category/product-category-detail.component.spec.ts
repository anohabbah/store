...
import { ProductCategoryDetailComponent } from '@store/entities/product-category/product-category-detail.component';
import { ProductCategory } from '@store/shared/model/product-category.model';
